...
TEST_F(OrderBookTest, ExactMatchProducesOneTradeAndEmptiesBook) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, NonCrossingBuyRestsAndBothSidesPopulated) {
...
TEST_F(OrderBookTest, IncomingLargerBuyConsumesAskAndRestsRemainder) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, RestingLargerAskKeepsRemainingQuantity) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, BuySweepsMultipleAskLevelsInPriceOrder) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, FIFOAtSamePriceFillsOldestOrderFirst) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, BuyGetsPriceImprovementFromBetterAsk) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, MarketBuySweepsMultipleAskLevels) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, MarketBuyLargerThanLiquidityDoesNotRest) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, SellAggressorConsumesBidAndLeavesRemainder) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, SellSweepsMultipleBidLevelsInPriceOrder) {
    std::vector<orderbook::Trade> trades;
...
TEST_F(OrderBookTest, BookAlwaysMaintainsValidSpreadAfterTrades) {
    std::vector<orderbook::Trade> trades;
